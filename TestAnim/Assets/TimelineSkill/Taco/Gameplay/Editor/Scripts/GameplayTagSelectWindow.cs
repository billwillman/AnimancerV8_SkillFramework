...
namespace Taco.Gameplay.Editor
{
    public class GameplayTagSelectWindow : EditorWindow
    {
        ...
        GameplayTagInfoView AddGameplayTagInfoView(string tag)
        {
            ...
            GameplayTagInfoView gameplayTagInfoView = new GameplayTagInfoView(lastPath, tag, m_TagContainer.IsChildOf(tag));
        ...
        GameplayTagInfoView AddRuntimeGameplayTagInfoView(string tag)
        {
            ...
            GameplayTagInfoView gameplayTagInfoView = new GameplayTagInfoView("(Runtime)" +lastPath, tag, m_TagContainer.IsChildOf(tag));
