...
namespace EasyCharacterMovement
{
    ...
    public sealed class CharacterMovement : MonoBehaviour
    {
        ...
        ///Taco
        public delegate void ModifyDeltaPositionCallback(ref Vector3 deltaPosition);
        public ModifyDeltaPositionCallback modifyDeltaPositionCallback { get; set; }
        ...
        public CollisionFlags Move(Vector3 newVelocity, float deltaTime = 0.0f)
        {
            ...
            Vector3 oldPosition = updatedPosition;
            ...
            updatedPosition = oldPosition + deltPosition;
