...
namespace UnityTimeline
{
    ...
    public class AA_SetInputLockNode : AnimancerAbilityActionNode
    {
        ...
        [SerializeField, PropertyPort(PortDirection.Input, "LockKey (持有者标识)"), Tooltip("持有者标识（如 \"Attack\", \"Dialogue\"），解锁时需传入相同 Key")]
        ...
        [SerializeField, PropertyPort(PortDirection.Input, "LockFlags (锁定通道)"), Tooltip("要锁定的输入通道标志位，可组合多个通道")]
