...
namespace SOC.GamePlay
{
    ...
    public class GameStart : MonoBehaviour
    {
...
#if !UNITY_WEIXINMINIGAME // ΢��С��Ϸ��Ҫ�ӿ�дĿ¼��ȡ
            if (IsDS) {
        ...
        void InitLuaEnv() {
            // 1.��ʼ��Lua����
            m_LuaEnv = new LuaEnv();
            m_LuaEnv.AddBuildin("rapidjson", XLua.LuaDLL.Lua.LoadRapidJson); // ע��rapidjson��
...
#endif
            _MOE.Set<string, bool>("IsDS", IsDS); // �Ƿ���DS 
            _MOE.Set<string, int>("Platform", (int)Application.platform); // ƽ̨
        }
